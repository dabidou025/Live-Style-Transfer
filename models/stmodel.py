...
class ConvCIN(nn.Module):
    def __init__(self, n_styles, C_in, C_out, kernel_size, padding, stride, apply_activation=True):
        ...
        self.instnorm = nn.InstanceNorm2d(C_out)
...
class ResidualBlock(nn.Module):
    def __init__(self, n_styles, C_in, C_out):
        ...
        self.convcin1 = ConvCIN(n_styles, C_in, C_out, kernel_size=3, padding=1, stride=1)
        self.convcin2 = ConvCIN(n_styles, C_in, C_out, kernel_size=3, padding=1, stride=1, apply_activation=False)
...
class UpSampling(nn.Module):
    def __init__(self, n_styles, C_in, C_out):
        ...
        self.convcin = ConvCIN(n_styles, C_in, C_out, kernel_size=3, padding=1, stride=1)
...
class STModel(nn.Module):
    def __init__(self, n_styles):
        ...
        self.convcin1 = ConvCIN(n_styles, C_in=3, C_out=32, kernel_size=9, padding=4, stride=1)
        self.convcin2 = ConvCIN(n_styles, C_in=32, C_out=64, kernel_size=3, padding=1, stride=2)
        self.convcin3 = ConvCIN(n_styles, C_in=64, C_out=128, kernel_size=3, padding=1, stride=2)
        ...
        self.convcin4 = ConvCIN(n_styles, C_in=32, C_out=3, kernel_size=9, padding=4, stride=1, apply_activation=False)
